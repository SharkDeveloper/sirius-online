"""
Django settings for sirius-online project.
...
# добавление Redis для каналов
REDIS_HOST = os.getenv('REDIS_HOST')
REDIS_PORT = os.getenv('REDIS_PORT')
REDIS_URL = f'redis://{REDIS_HOST}:{REDIS_PORT}'
GROUP_EXPIRE = 86400  # Время жизни группы: 24 часа
CHANNEL_LAYERS = {
    'default': {
        ...
        "capacity": 10_000,  # Максимальное количество сообщений в очереди
        "group_expiry": GROUP_EXPIRE,  
    },
}
...
# #TODO изменить ip для деплоя
# CSRF_TRUSTED_ORIGINS = ['http://192.168.22.186']
